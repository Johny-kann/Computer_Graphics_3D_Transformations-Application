...
/**
 * @author Derived class from oracle documentation
 *General Class that is used to set the pre-defined graphics settings.
 *This class is used to set the rotation of the cameras and not the graphics image
 */
